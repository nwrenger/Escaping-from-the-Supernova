...
pub fn init(proc: [u8; 4], seed: u8) {
    match proc[2] {
        1 => {
            ...
            match select_num("What will you do?\n", &["control console", "annoying Fly"]) {
                1 => {
                    println!("\nOn the control console, you see that a supernova will obliterate the ship and you in the next 5 minutes.\n");
                    match select_num("Do you want to fly behind a moon nearby or do nothing and wait for your death?\n", &["Fly behind moon", "Wait for death"]) {
                ...
                2 => {
                    ...
                    match select_num("Do you want to kill the fly or negotiate with it?\n", &["kill", "negotiate"]) {
        ...
        2 => {
            ...
            match select_num("What do you fix first?\n", &["hull", "control console"]) {
                1 => {
                    ...
                    match select_num("Do you want to jump into Jesus arms or do you want to fix up the hole?\n", &["Jesus", "Fix up the hole"]) {
                ...
                2 => {
                    ...
                    match select_num("Do you want to extinguish it or run away?\n", &["extinguish", "RUN!?!?"]) {
        ...
        3 => {
            ...
            match select_num(
                ...
                1 => {
                    ...
                    match select_num("You know to play the Damen Gambit Opening and win or you can also try to throw the game.\n", &["Damen Gambit", "Throw"]) {
                ...
                2 => {
                    ...
                    match select_num("You can either reverse time or throw the precious Flux Capacitor at the Supernova.\n", &["reverse time", "throw the precious"]) {
